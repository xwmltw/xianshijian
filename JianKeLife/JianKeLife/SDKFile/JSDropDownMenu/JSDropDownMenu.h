...
@property (nonatomic, strong) UIColor *indicatorColor;//下拉图标
@property (nonatomic, strong) UIColor *textColor;
@property (nonatomic, strong) UIColor *separatorColor;//底部分割线

@property (nonatomic, strong) UIColor *indicatorHightColor;
@property (nonatomic, strong) UIColor *textHightColor;//选择颜色
