...
@implementation HighShareModelView
- (void)requestTypeDate{
    ...
    WEAKSELF
    [XNetWork requestNetWorkWithUrl:Xlist_favorite_product andModel:[self.hiBuyProductQueryModel mj_keyValues] andSuccessBlock:^(ResponseModel *model) {
...
- (MJRefreshAutoNormalFooter *)creatMjRefresh{
    ...
    [self.footer setTitle:@"我是有底线的 ~ ~ ￣□￣｜｜" forState:MJRefreshStateIdle];
