...
{
    if (!_hotSearchView) {
        self.hotSearchView = [self setViewWithOriginY:CGRectGetHeight(_searchHistoryView.frame) title:@"大家都在搜索" textArr:self.hotArray];
    }
...
- (UIView *)setViewWithOriginY:(CGFloat)riginY title:(NSString *)title textArr:(NSMutableArray *)textArr
{
    ...
    UILabel *titleL = [[UILabel alloc] initWithFrame:CGRectMake(15, 10, ScreenWidth - 30 - 45, 30)];
    titleL.text = title;
